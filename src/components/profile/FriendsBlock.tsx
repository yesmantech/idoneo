...
export default function FriendsBlock({ userId }: FriendsBlockProps) {
    ...
    return (
        <>
            ...
            {/* ─── Success Toast (floating, like AI coach copy) ─── */}
            <AnimatePresence>
                {showToast && (
                    <motion.div
                        ...
                        className="fixed bottom-24 left-1/2 -translate-x-1/2 z-[100] px-5 py-3 rounded-2xl bg-emerald-500 shadow-lg shadow-emerald-500/30 flex items-center gap-2.5"
                    >
