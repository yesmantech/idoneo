...
function FeaturedCard({ post }: FeaturedCardProps) {
    return (
        <Link
            to={`/blog/${post.slug}`}
            className="block relative overflow-hidden rounded-[28px] lg:rounded-[32px] group shadow-soft border border-[var(--card-border)] transition-all duration-700 hover:shadow-hover"
            style={{
                aspectRatio: '16 / 9',
            }}
        >
...
function SmallCard({ post }: SmallCardProps) {
    return (
        <Link
            to={`/blog/${post.slug}`}
            className="block relative overflow-hidden rounded-[20px] lg:rounded-[24px] group shadow-soft border border-[var(--card-border)] transition-all duration-500 hover:shadow-hover"
            style={{
                aspectRatio: '16 / 9',
            }}
        >
            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
                    ...
                    <div className="lg:col-span-2">
                        <div
                            className="bg-slate-200 dark:bg-slate-700 animate-pulse rounded-[24px]"
