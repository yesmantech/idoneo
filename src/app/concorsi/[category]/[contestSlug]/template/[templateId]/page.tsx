...
export default function TemplateDetailPage() {
    ...
    return (
        <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] pb-40 overflow-x-hidden relative transition-colors duration-300">
            ...
            <div className="fixed bottom-0 left-0 right-0 px-6 py-4 bg-white/80 dark:bg-black/80 backdrop-blur-xl border-t border-slate-200/50 dark:border-white/5 z-50" style={{ paddingBottom: 'max(16px, var(--safe-area-bottom))' }}>
