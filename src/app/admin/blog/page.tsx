    ...
    const columns = [
        {
            ...
            render: (post: BlogPost) => (
                <div>
                    <div className="font-semibold text-[var(--foreground)]">{post.title}</div>
                    <div className="text-xs text-[var(--foreground)] opacity-30 font-mono">/blog/{post.slug}</div>
                </div>
            )
        },
        {
        ...
        },
        {
            ...
            width: '150px',
            render: (post: BlogPost) => (
                <span className="text-sm text-[var(--foreground)] opacity-40">
                    {post.category?.name || '-'}
                </span>
            )
        },
        ...
        },
        {
            ...
            render: (post: BlogPost) => (
                <span className="text-sm text-[var(--foreground)] opacity-40 font-mono">
                    {post.view_count}
                </span>
            )
        }
        ...
        <AdminLayout>
            ...
            <div className="flex gap-4 mb-6">
                <button
                    ...
                    className="px-4 py-2 bg-[var(--card)] hover:bg-slate-50 dark:hover:bg-slate-800 border border-[var(--card-border)] rounded-xl text-[var(--foreground)] opacity-70 text-sm font-medium transition-colors shadow-sm"
                >
                    Gestisci Categorie
                </button>
                <button
            ...
            {/* FILTERS */}
            <div className="mb-6 p-4 bg-[var(--card)] border border-[var(--card-border)] rounded-[20px] flex flex-col md:flex-row gap-4 shadow-[0_4px_16px_rgba(0,0,0,0.04)]">
