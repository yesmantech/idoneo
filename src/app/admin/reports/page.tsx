            ...
            <div className="max-w-[1600px] mx-auto">
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="px-4 py-2 bg-white dark:bg-[#111] rounded-xl border border-slate-200 dark:border-slate-700 font-mono text-sm">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-6">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 bg-white dark:bg-[#111] border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-[#00B1FF]"
                        />
                    </div>
                    <div className="flex items-center bg-white dark:bg-[#111] border border-slate-200 dark:border-slate-700 rounded-xl p-1">
                ...
                {/* Table */}
                <div className="bg-white dark:bg-[#111] border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden shadow-sm">
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-black/50">
                                            ...
                                            <td className="p-4 align-top">
                                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${report.status === 'pending'
                                                    ...
                                                    : report.status === 'resolved'
                                                        ...
                                                        : 'bg-slate-100 text-slate-600 border-slate-200 dark:bg-[#111] dark:text-slate-400 dark:border-slate-700'
                                                    }`}>
                                                    {report.status}
                                                </span>
                                            </td>
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    {report.report_type === 'ai_feedback' ? (
                                                        ...
                                                        <>
                                                            ...
                                                            {report.description && (
                                                                <div className="text-xs text-slate-500 bg-slate-50 dark:bg-black/50 p-2 rounded-lg border border-slate-100 dark:border-slate-800">
                                                                    "{report.description}"
                                                                </div>
                                                            )}
                    ...
                    {/* Pagination Controls */}
                    {totalPages > 1 && (
                        <div className="flex items-center justify-between p-4 border-t border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-black/50">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="px-4 py-2 text-sm font-medium rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#111] text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                                >
                                    ← Precedente
                                </button>
